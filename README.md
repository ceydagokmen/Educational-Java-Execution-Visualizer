# Educational Java Execution Visualizer
...
* **Structure X-Ray (AST):** View the **Abstract Syntax Tree** to understand how the compiler organizes your code.
...
2. **Arithmetic:** Simple mathematical operations.
3. **Strings:** Handling reference types and memory.
4. **Control Flow:** If-Else logic and decision points.
...
* **Azra Günay** - [GitHub Profile](https://github.com/azraag)
